...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-06 11:14`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c599f0e8-609c-4591-a86b-eeaec010abd4.git
$ cd c599f0e8-609c-4591-a86b-eeaec010abd4
```
